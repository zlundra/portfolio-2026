    ...
    <footer className="border-t border-white/5 bg-black/20 backdrop-blur-sm py-12 mt-20">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-muted-foreground max-w-sm leading-relaxed">
              Business &amp; product analytics across PropTech and healthcare regulation — delivered with clean data, strong governance, and clear storytelling.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://linkedin.com/in/valentina-resner"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-white/5 hover:bg-primary/20 hover:text-primary transition-all"
              >
        ...
        <div className="border-t border-white/5 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <p>
            Built with <span className="text-primary">♥</span> for analytics &amp; product impact
          </p>
        </div>
      </div>
    </footer>
